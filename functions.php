...
function add_aran_scripts()
{
    ...
    wp_enqueue_script("splide-script", 'https://cdn.jsdelivr.net/npm/@splidejs/splide@4.1.4/dist/js/splide.min.js');
...
require dirname(__FILE__) . '/functions-part/cpt-cucine.php';
