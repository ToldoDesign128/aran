...
<main class="py-24">
    <section class="relative">
        ...
        <div class="2xl:max-w-screen-2xl xl:max-w-screen-xl lg:max-w-screen-lg md:max-w-screen-md md:m-auto md:px-8 px-4 lg:py-24 py-12 flex lg:flex-row flex-col justify-between">
            <h2 class="lg:w-7/12 w-full xl:text-5xl lg:text-4xl text-3xl font-serif uppercase"><?php echo esc_html(get_field('titolo_pagina_cucine', 284)); ?></h2>
            <p class="lg:w-5/12 w-full lg:pt-0 pt-12"><?php echo esc_html(get_field('testo_pagina_cucine', 284)); ?></p>
        </div>
    </section>
    ...
    <section class="2xl:max-w-screen-2xl xl:max-w-screen-xl lg:max-w-screen-lg md:max-w-screen-md md:m-auto md:px-8 px-4 py-20">
        ...
        <div class="flex flex-col">
            <?php
            if (have_rows('cucine_faq', 284)) :

                while (have_rows('cucine_faq', 284)) : the_row();

                    $faq_domanda_cucina = get_sub_field('domanda_cucine_faq', 284);
                    $faq_risposta_cucina = get_sub_field('risposta_cucine_faq', 284); ?>
